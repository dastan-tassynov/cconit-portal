...
export class SimpleTranslateService {
  ...
  private translations: any = {
    ...
    ru: {
      ...
      'LABEL_EMAIL_IIN': 'E-mail',
      'PLACEHOLDER_EMAIL_IIN': 'name@example.com',
      ...
      'FOOTER_CONTACTS': 'Контакты: +7 (707) 713 11 31',
      ...
      hero_title: 'Добро пожаловать в ЦОНИТ',
      hero_desc: 'Центр обеспечения научно-инновационных технологий (ЦОНИТ) — это экспертная площадка, объединяющая передовые научные подходы и современные технологические решения.',
      dir_1: 'Научно-исследовательские разработки',
      dir_1_desc: 'проведение прикладных исследований и адаптация технологий под задачи.',
      dir_2: 'Цифровая трансформация',
      dir_2_desc: 'автоматизация процессов и внедрение инновационного ПО.',
      dir_3: 'Консалтинг и экспертиза',
      dir_3_desc: 'профессиональное сопровождение и аудит технологий.'
    },
    kk: {
      ...
      'FOOTER_CONTACTS': 'Байланыс: +7 (707) 713 11 31',
      ...
      hero_title: 'ЦОНИТ-ке қош келдіңіз',
      hero_desc: 'Ғылыми-инновациялық технологияларды қамтамасыз ету орталығы (ЦОНИТ) — бұл озық ғылыми тәсілдер мен заманауи технологиялық шешімдерді біріктіретін сараптамалық алаң.',
      dir_1: 'Ғылыми-зерттеу әзірлемелері',
      dir_1_desc: 'қолданбалы зерттеулер жүргізу және технологияларды нақты міндеттерге бейімдеу.',
      dir_2: 'Цифрлық трансформация',
      dir_2_desc: 'процестерді автоматтандыру және инновациялық бағдарламалық қамтамасыз етуді енгізу.',
      dir_3: 'Консалтинг және сараптама',
      dir_3_desc: 'жобаларды кәсіби сүйемелдеу және технологиялық аудит.'
    }
  };
