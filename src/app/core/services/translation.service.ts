...
export class SimpleTranslateService {
  ...
  private translations: any = {
    ...
    ru: {
      ...
      'VAL_SYSTEM': 'Система ЦОНИТ', 'TITLE_MY_CERTS': 'Мои сертификаты', 'TH_DISCIPLINE': 'Дисциплина',
    ...
    kk: {
      ...
      'VAL_SYSTEM': 'ЦОНИТ жүйесі', 'TITLE_MY_CERTS': 'Менің сертификаттарым', 'TH_DISCIPLINE': 'Пән',
